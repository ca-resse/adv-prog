...
public class FormSurveyController {
    ...
    public FormSurveyController(int survID, int respID) throws IOException {
        this.survID = survID;
        this.respID = respID;
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FormSurvey.fxml"));
    ...
    public void back(ActionEvent event) throws IOException {
        new EditSurveyController(10001);
    }

    public void initSurv() throws IOException {
        // Reads data from JSON files
        String survRead = new String((Files.readAllBytes(Paths.get("src/main/resources/com/group10/JSON/Surveys/Survey_" + survID + ".json"))));
        JSONObject survData = new JSONObject(survRead);
//        String respRead = new String((Files.readAllBytes(Paths.get("/JSON/Responses/Response_" + String.format("%04d", survID) + ".json"))));
//        JSONArray respData = new JSONArray(respRead);
        ...
        for (Object ques : quesArr) {
            FXMLLoader newQues = new FXMLLoader(getClass().getResource("FormQuestion.fxml"));
    ...
    public void save() throws IOException {
        String jsonRead = new String((Files.readAllBytes(Paths.get("src/main/resources/JSON/Responses/Response_" + survID + ".json"))));
...
//            responsesList.put(response);
        ...
        FileWriter jsonWrite = new FileWriter("src/main/resources/JSON/Responses/Response_" + survID + ".json");
